...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View All Doctors and Authorize </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="100" bgcolor="#9eb8dd"><div align="center" class="style10 style12 style8 style13 style15">Doctor Image</div></td>
           <td width="145" bgcolor="#9eb8dd"><div align="center" class="style10 style12 style8 style13 style16">Doctor Name</div></td>
	...
	{		
		...
		%>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#00FFFF" align="center"><input  name="image" type="image" style="width:100px; height:90px;" src="d_Pic.jsp?id=<%=i%>" /></td>
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style10 style11 style8 style13"><%=s2%></div></td>
					  <td width="130" align="center" bgcolor="#00FFFF"><a href="c_doc_profile.jsp?user=<%=s2%>&type=<%="one"%>" class="style16 style10 style11 style8 style13">Click here</a></td>
					  <%
              ...
              <td bgcolor="#00FFFF"><div align="center" class="style16 style10 style11 style8 style13">
                <a href="c_d_Status.jsp?id=<%=i%>" class="style19">waiting</a> </div></td>
              <%
						}
						else
						{

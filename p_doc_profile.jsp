...
<table width="576" height="395" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						try 
						{
						   	String query="select * from doctors where name='"+user+"'"; 
					...
					%>
            <tr>
              <td width="200" rowspan="6"><input name="image" type="image" src="d_Pic.jsp?id=<%=i%>" style="width:200px; height:200px;" /></td>
            </tr>
            <tr>
...
if(type.equalsIgnoreCase("one"))
		{
		%> <p align="right"><a href="p_d_response.jsp" class="style7">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="ppp.jsp" class="style7">Back</a></p>
<%
		}

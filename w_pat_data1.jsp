...
<head>
<title>Patient Collected Data </title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View Patient Collected Data (Encrypted)  </h2>
		  <p>&nbsp;</p>
...
<table width="620" border="1" align="center" cellspacing="0" cellpadding="10">
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s3%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s4%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s5%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s6%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s7%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s15%></span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td width="329" bgcolor="#CCCC00"><span class="style14"><%=s8%></span></td>
      </tr>
...
%>
        ...
        <p>&nbsp;</p>
		<p align="right"><a href="w_pat_data.jsp" class="style6">Back</a></p>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">

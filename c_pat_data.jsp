...
<head>
<title>Patients Cloudlet Data </title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View All Patients Cloudlet Data  </h2>
		  <p>&nbsp;</p>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style11 style13 style7 style8 style10"><a href="c_pat_profile.jsp?user=<%=s2%>&type=<%="three"%>" class="style16 style10 style11 style8 style13"><%=s2%></a></div></td>
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style11 style13 style7 style8 style10"><%=s12%></div></td>
					  <td width="171" align="center" bgcolor="#00FFFF"><a href="c_pat_data1.jsp?pid=<%=i%>" class="style16 style11 style13 style7 style8 style10">Click Here</a></td>
	                </tr>

...
.style8 {font-family: "Times New Roman", Times, serif; font-size: 25px; }
-->
</style>
</head>
<body>
...
<form name="s" action="d_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
	...
	<p align="center"><span class="style7">New User? </span> <a href="d_register.jsp" class="style8">Register Here</a> </p>
</form>		  

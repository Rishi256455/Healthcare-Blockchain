...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to Doctor Main : <span class="style6"> <%=application.getAttribute("doc")%> </span> </h2>
		  <p><img src="images/Doctor.jpg" width="612" height="218" /></p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style7">
            <li><a href="d_profile.jsp"> My Profile </a></li>

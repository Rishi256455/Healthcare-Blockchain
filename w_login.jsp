...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Hospitals LogIn  </h2>
		  <p>&nbsp;</p>
...
<form name="s" action="w_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
    ...
    <table align="center" border="1" width="51%" height="198">
	
      <tr>
        <td height="36" bgcolor="#FF9999" class="style5 style2 style6">Select Block </td>
        <td height="36" bgcolor="#FF9999"><select name="select">
      ...
      <tr>
        <td width="48%" height="36" bgcolor="#FF9999" class="style5 style2"> <span class="style9 style6 style2 style4 style5">User Name</span></td>

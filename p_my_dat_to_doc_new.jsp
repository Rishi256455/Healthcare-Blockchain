...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View All My Collected Datas(Reports)  </h2>
		  <p>&nbsp;</p>
...
<%
							...
							String query="select * from cloudlet_files where pname='"+pname+"' and upload_by='Device' "; 
...
<%
		...
		%>
                    ...
                    <tr>
					  ...
					  <td width="171" align="center" bgcolor="#00FFFF"><a href="p_my_dat_to_doc.jsp?id=<%=i%>" class="style16 style13 style7 style8 style10">Click Here</a></td>
	                </tr>

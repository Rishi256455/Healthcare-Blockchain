...
if(type.equalsIgnoreCase("one"))
		{
		%> <p align="right"><a href="d_pat_solve.jsp" class="style7">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="d_pat_mp_details.jsp" class="style7">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("three"))
		{
		%><p align="right"><a href="ddd.jsp" class="style7">Back</a></p>
<%
		}

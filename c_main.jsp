    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="c_login.jsp"><span>Healthcare Cloud</span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
	      <div align="center"><img src="images/Cloudlet.jpg" width="433" height="206" /></div>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">

...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Enter Patient Name</h2>
		  <p>&nbsp;</p>
...
<form name="s" action="i_login1.jsp" method="post" onSubmit="return valid()"  ons target="_top">
	...
	<table width="598" border="1" align="center" cellspacing="0" cellpadding="10">
	  ...
	  <tr>
        ...
        <td width="356" bgcolor="#CCCC00"><input name="p1" type="text" id="p1" size="50" /></td>
      </tr>
      ...
      <tr>
        ...
        <td bgcolor="#CCCC00"><input type="submit" name="Submit" value="Continue" /></td>
      </tr>
    </table>
</form>

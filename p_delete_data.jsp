...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View All My Datas(Reports) and Delet  </h2>
		  <p>&nbsp;</p>
...
<table width="541" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
           ...
           <td width="203" bgcolor="#9eb8dd"><div align="center" class="style12 style13 style16 style7 style8 style9">Delete</div></td>
		 </tr>
...
<%
		...
		%>
                    ...
                    <tr>
					  ...
					  <td width="171" align="center" bgcolor="#00FFFF"><a href="p_delete_data1.jsp?id=<%=i%>" class="style16 style13 style7 style8 style10">Click Here</a></td>
	                </tr>

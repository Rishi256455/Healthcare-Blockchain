...
<form name="s" action="p_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
	...
	<p align="center"><span class="style7">New User? </span> <a href="p_register.jsp" class="style8">Register Here</a> </p>
</form>		  

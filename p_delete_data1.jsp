...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Deleting Data  </h2>
		  <p>&nbsp;</p>
...
<%	  
 ...
 try 
	{		
				...
				String query1 = "delete from cloudlet_files where id="+ id + " ";
				int x = stmt1.executeUpdate(query1);
				if(x>0)
				{
				%> 
								<p align="center" class="style12"> Your Data Deleted Succesfully. </p>
								<p>&nbsp;</p>
								<p align="right"><a href="p_delete_data.jsp" class="style6">Back</a></p> 
<%
				}

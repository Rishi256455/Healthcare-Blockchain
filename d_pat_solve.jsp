...
<head>
<title> My Patient Reports </title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View Patient Details and Give Solution  </h2>
		  <p>&nbsp;</p>
...
<table width="594" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="157" bgcolor="#9eb8dd"><div align="center" class="style12 style13 style16 style7 style8 style9">Patient Name</div></td>
		   <td width="173" bgcolor="#9eb8dd"><div align="center" class="style12 style13 style16 style7 style8 style9">Sent on Date</div></td>
           <td width="111" bgcolor="#9eb8dd"><div align="center" class="style12 style13 style16 style7 style8 style9">Patient Details</div></td>
		 </tr>
...
<%	  
 ...
 try 
	{		
      	                    String query="select * from doctor_files where dname='"+dname+"' "; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style11 style13 style7 style8 style10"><a href="d_pat_profile.jsp?user=<%=s2%>&type=<%="one"%>" class="style16 style10 style11 style8 style13"><%=s2%></a></div></td>
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style11 style13 style7 style8 style10"><%=s12%></div></td>
					  <td width="111" align="center" bgcolor="#00FFFF"><a href="d_pat_solve1.jsp?pid=<%=i%>" class="style16 style11 style13 style7 style8 style10">Click Here</a></td>
	                </tr>
...
%>
        ...
        <p>&nbsp;</p>
		<p align="right"><a href="d_main.jsp" class="style6">Back</a></p>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">

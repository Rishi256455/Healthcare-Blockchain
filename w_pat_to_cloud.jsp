...
<table width="541" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
           ...
           <td width="203" bgcolor="#9eb8dd"><div align="center" class="style12 style13 style16 style7 style8 style9">Select & Upload<br />Patient Data</div></td>
		 </tr>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style11 style13 style7 style8 style10"><%=s2%></div></td>
					  <td width="171" align="center" bgcolor="#00FFFF"><a href="w_pat_to_cloud1.jsp?pat=<%=s2%>" class="style16 style11 style13 style7 style8 style10">Select</a></td>
	                </tr>
...
%>
        ...
        <p>&nbsp;</p>
		<p align="right"><a href="w_main.jsp" class="style6">Back</a></p>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">
